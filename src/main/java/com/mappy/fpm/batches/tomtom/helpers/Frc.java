...
public enum Frc {
    ...
    OTHER_MAJOR_ROAD(2, false, false, of("highway", "primary")),
    OTHER_MAJOR_ROAD_link(2, true, false, of("highway", "primary_link")),
    SECONDARY_ROAD(3, false, false, of("highway", "secondary")),
    SECONDARY_ROAD_LINK(3, true, false, of("highway", "secondary_link")),
    LOCAL_CONNECTING_ROAD(4, false, false, of("highway", "secondary")),
    LOCAL_CONNECTING_ROAD_LINK(4, true, false, of("highway", "secondary_link")),
    LOCAL_ROAD_OF_HIGH_IMPORTANCE(5, false, false, of("highway", "secondary")),
    LOCAL_ROAD_OF_HIGH_IMPORTANCE_LINK(5, true, false, of("highway", "secondary_link")),
    LOCAL_ROAD(6, false, false, of("highway", "residential")),
    LOCAL_ROAD_LINK(6, true, false, of("highway", "tertiary_link")),
    LOCAL_ROAD_OF_MINOR_IMPORTANCE(7, false, false, of("highway", "residential")),
    LOCAL_ROAD_OF_MINOR_IMPORTANCE_LINK(7, true, false, of("highway", "tertiary_link")),
    OTHER_ROAD(8, false, false, of("highway", "unclassified"));
