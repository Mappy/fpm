...
public class SpeedProfilesTest {
    ...
    public void should_avoid_null_if_speed_restrictions_are_not_found() {
        ...
        SpeedProfiles profiles = new SpeedProfiles(new HspnDbf(folder), new HsprDbf(folder));

        assertThat(profiles.extracted(onlyTags(ImmutableMap.of("ID", "12500000000046"))))
        ...
        assertThat(profiles.extracted(onlyTags(ImmutableMap.of("ID", "12500000000071"))))
