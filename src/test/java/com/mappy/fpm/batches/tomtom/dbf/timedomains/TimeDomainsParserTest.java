...
public class TimeDomainsParserTest {
    ...
    @Test
    public void should_translate_tomtom_time_domain_to_osm_opening_hours(){
    ...
    @Test
    public void should_translate_tomtom_time_domain_over_midnight_to_osm_opening_hours(){
    ...
    @Test
    public void should_translate_tomtom_time_domain_with_month_to_osm_opening_hours(){
    ...
    @Test
    public void should_translate_tomtom_time_domain_with_month_over_year_to_osm_opening_hours(){
    ...
    @Test
    public void should_translate_tomtom_time_domain_collection_to_osm_opening_hours(){
        TimeDomains tomtomTimesDomains = new TimeDomains(14420000000590L, "[(h6){h2}]");
