...
public class MetalinkParserTest {
    ...
    public void should_parse_metalink() {
        ...
        assertThat(metalink.forCountry("fra"))
                .isEqualTo(new Metalink(newArrayList(MetalinkUrl.parseMetalinkUrl("eur2016_03-shpd-2dcmnb-fra-f10.7z.001", "http://edelivery2.tomtom.com/eur2016_03-shpd-2dcmnb-fra-f10.7z.001"))));
